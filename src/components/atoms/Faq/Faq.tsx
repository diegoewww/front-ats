    ...
    <section className='relative max-w-screen-xl mx-auto px-4 py-28 gap-12 md:px-8 flex flex-col justify-center items-center'>
      ...
      >
        ...
        <p className='max-w-xl text-foreground/80 text-center'>
          Estas son algunas de nuestras preguntas frecuentes. Si tiene alguna otra pregunta que le gustaría responder, no dude en enviarnos un correo electrónico.
        </p>
      </motion.div>
      ...
      <div className='absolute w-40 h-40 border bg-light -left-28 top-0 blur-[200px]' />
    </section>
  )
}
